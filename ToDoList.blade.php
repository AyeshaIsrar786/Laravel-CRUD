...
<div class="flex">   
    <div class="flex justify-left max-w-xl mx-10 my-20 p-20 bg-indigo-50 rounded-lg">
        ...
        <form id="data" class="mx-5 my-20" method="post" action="{{'/lists'}}">
        @csrf
    ...
    <div class="flex justify-right p-20">
        <table class="table-auto border-seperate bg-indigo-50">
            ...
            @foreach($list as $data)
				<tr>
					...
					<td>
					<a href="{{url('/lists/edit')}}/{{$data->id}}" class="mx-0 bg-green-500 hover:bg-green-300 text-white py-2 px-2 rounded-lg">Edit</a>
